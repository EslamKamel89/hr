...
<body>
  <div class="container-scroller">
    <!-- partial:../../partials/_horizontal-navbar.htm')}} -->
      ...
      <nav class="bottom-navbar">
        <div class="container">
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                  <a href="{{asset('admin/pages/forms/basic_elements.htm')}}" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="{{asset('admin/pages/charts/chartjs.htm')}}" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="{{asset('admin/pages/tables/basic-table.htm')}}" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="{{asset('admin/pages/icons/mdi.htm')}}" class="nav-link">
              ...
              <li class="nav-item">
                  ...
                  <div class="submenu">
                      <ul class="submenu-item">
                          <li class="nav-item"><a class="nav-link" href="{{asset('admin/pages/samples/login.htm')}}">Login</a></li>
                          <li class="nav-item"><a class="nav-link" href="{{asset('admin/pages/samples/login-2.htm')}}">Login 2</a></li>
                          <li class="nav-item"><a class="nav-link" href="{{asset('admin/pages/samples/register.htm')}}">Register</a></li>
                          <li class="nav-item"><a class="nav-link" href="{{asset('admin/pages/samples/register-2.htm')}}">Register 2</a></li>
                          <li class="nav-item"><a class="nav-link" href="{{asset('admin/pages/samples/lock-screen.htm')}}">Lockscreen</a></li>
                      </ul>
                  </div>
              </li>
              <li class="nav-item">
                  <a href="{{asset('admin/docs/documentation.htm')}}" class="nav-link">
