        ...
        <div class="col-lg-4 mb-3 mb-lg-0">
            <div class="card congratulation-bg text-center">
                <div class="card-body pb-0">
                    <img src="{{ asset('admin/images/dashboard/face29.png') }}" alt="">
                                ...
                                <ul class="nav nav-tabs tab-no-active-fill" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ps-2 pe-2" id="server-loading-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false">Server loading</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ps-2 pe-2" id="sales-by-traffic-tab" data-bs-toggle="tab"
                                            href="#sales-by-traffic" role="tab" aria-controls="sales-by-traffic"
                                            aria-selected="false">Sales by traffic</a>
                                    </li>
                                </ul>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="position-relative">
                                        <img src="{{ asset('admin/images/dashboard/live.png') }}" class="w-100"
                                            alt="">
                            ...
                            <div class="row pt-3 mt-md-1">
                                ...
                                <div class="col">
                                    <div class="d-flex purchase-detail-legend align-items-center">
                                        <div id="circleProgress2" class="p-2" percent="0.55">
                                        </div>
                                        <div>
                                            <p class="font-weight-medium text-dark text-small">Users
                                            </p>
                                            <h3 class="font-weight-bold text-dark  mb-0">90.80%</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
